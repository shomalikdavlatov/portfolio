...
export default function Projects() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-8">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-8 text-neutral-900 dark:text-white">
        {t("myprojects.title")}
      </h2>
